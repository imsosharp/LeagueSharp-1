...
namespace TAC_Jax
{
    class Jax
    {
        ...
        static void Main(string[] args)
        {
            ...
            Game.PrintChat("[" + Utils.FormatTime(Game.ClockTime) + "] <font color='#00ff00'>System (Kappa):</font> <font color='#FF0000'>[v1.3]</font> <font color='#7A6EFF'>Twilight's Auto Carry: </font> <font color='#86E5E1'>Jax</font>");
